...
export const ArticleParamsForm = ({ onStyleChange, onStyleReset }: ArticleParamsFormProps) => {
	...
	return (
	  <>
		...
		{isFormOpen && (
		  <aside ref={formRef} className={clsx(styles.container, isFormOpen && styles.container_open )}>
			<form className={clsx(styles.form)} onSubmit={handleSubmit} onReset={handleReset}>
            ...
            />
			  <div className={styles.bottomContainer}>
				<Button title='Сбросить' type='reset' className={button_styles.reset_button} />
				<Button title='Применить' type='submit' className={button_styles.submit_button} />
			  </div>
			</form>
		  </aside>
		)}
